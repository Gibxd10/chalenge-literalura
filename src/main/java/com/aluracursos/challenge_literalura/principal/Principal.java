...
import com.aluracursos.challenge_literalura.repository.*;
import com.aluracursos.challenge_literalura.service.*;
...
public class Principal {
    ...
    private void mostrarMenu() {
        System.out.println("""
                ==========================================================================================
                Bienvenido a la Librería LiterALURA
                ==========================================================================================
    ...
    private void buscarLibro() {
        try {
            ...
            if (newLibro.isPresent()) {
                ...
                Autor autor = new Autor(newLibro.get().autor());
